(function () {
    ...
    IssueViewer.Issue = Backbone.Model.extend({
        initialize: function (options) {
            this.urlRoot = 'https://api.github.com/repos/rails/rails/issues/' + options.number;
        }
    });

    IssueViewer.Issues = Backbone.Collection.extend({
        initialize: function (options) {
            this.url = 'https://api.github.com/repos/rails/rails/issues?page=' + options.page_num;
        }
    });

    IssueViewer.Comments = Backbone.Collection.extend({
        initialize: function (options) {
            this.url = 'https://api.github.com/repos/rails/rails/issues/' + options.number + '/comments';
        }
    });
